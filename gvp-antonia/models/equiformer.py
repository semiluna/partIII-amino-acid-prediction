...
# TODO: fixnumber of dimensions for features_in, edge_features and make MLP output 20 possible aminoacids
...
class GraphAttentionTransformer(torch.nn.Module):
    def __init__(self,
        ...
        drop_path_rate=0.0,
        mean=None, std=None, scale=None, atomref=None, **other_args):
        super().__init__()
